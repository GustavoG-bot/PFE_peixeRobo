...
void loop() {
  ...
  float v = 5.0 * avg_val/(128*(pow(2,24)- 1));
  Serial.print("Sinal inicial (Leitura ADC do sensor): ");
  Serial.println(avg_val / pow(10,7),5);
  Serial.print("Voltagem (mV): ");
  Serial.println(v * 1000,5); // print out the average
}